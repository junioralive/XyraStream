...
import { getGenereMovie, getGenereTV } from "@/lib/MultiFunctions"; // Adjust import paths
...
const Movies = () => {
  ...
  useEffect(() => {
    ...
    setGenreId(searchParams.get("genre"));
  }, [searchParams]);
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const data =
        type === "movie"
          ? await getGenereMovie(genreId, page)
          : await getGenereTV(genreId, page);
